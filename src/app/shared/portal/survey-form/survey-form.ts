...
@Component({ selector: 'app-survey-form', imports: [], templateUrl: './survey-form.html', styleUrl: './survey-form.css' })
export class SurveyForm {
  ...
  constructor() { this.surveysApi.list().subscribe({
    next: (surveys) => { this.surveys.set(surveys); this.message.set(surveys.length ? 'Selecciona una encuesta para comenzar.' : 'No hay encuestas disponibles.'); },
